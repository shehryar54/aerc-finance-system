...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Dashboard — Smart Finance System" },
      { name: "twitter:description", content: "Real-time overview of banks, cash flow, payroll and recent activity." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/b08e3fcc-c1c9-421d-96de-e2bd3577fb30/id-preview-8ff2adb7--e3732567-ed2e-4c4c-afc5-d95c6c2663d5.lovable.app-1785934334669.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/b08e3fcc-c1c9-421d-96de-e2bd3577fb30/id-preview-8ff2adb7--e3732567-ed2e-4c4c-afc5-d95c6c2663d5.lovable.app-1785934334669.png" },
    ],
    links: [
